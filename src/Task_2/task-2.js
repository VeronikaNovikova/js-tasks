...
let entrance_field = document.getElementById('entrance');
let floor_field = document.getElementById('floor');
...
function check(event) {
  ...
  let maxEntranceField = document.getElementById('max_entrance');
  let maxApartmentsOnFloorField = document.getElementById('max_apartments_on_floor');
  ...
  let maxApartments = maxFloorField.value * maxEntranceField.value * maxApartmentsOnFloorField.value;
  ...
  let entrance = Math.ceil(room / ( maxFloorField.value * maxApartmentsOnFloorField.value));
  let floor = Math.ceil((room / maxApartmentsOnFloorField.value) % maxEntranceField.value);
